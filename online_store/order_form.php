...
$stmt = $pdo->prepare("SELECT full_name, phone, address, card_number FROM users WHERE id = ?");
...
<div class="container">
    ...
    <form class="order-form" action="place_order.php" method="post">
        ...
        <div>
            ...
            <input type="text" id="card_number" name="card_number" value="<?= htmlspecialchars($user['card_number'] ?? '') ?>" required>
        </div>
        <div>
